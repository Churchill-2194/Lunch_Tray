...
class AccompanimentMenuFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            var AccompanimentMenu = this@AccompanimentMenuFragment
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.action_accompanimentMenuFragment_checkoutFragment)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.action_accompanimentMenuFragment_sideMenuFragment)
    }
