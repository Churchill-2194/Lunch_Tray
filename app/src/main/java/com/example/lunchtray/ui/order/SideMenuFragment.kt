...
class SideMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.action_sideMenuFragment_accompanimentMenuFragment)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.action_sideMenuFragment_entreeMenuFragment)
    }
