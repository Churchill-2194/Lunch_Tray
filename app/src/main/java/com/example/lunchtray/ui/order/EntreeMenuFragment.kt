...
class EntreeMenuFragment : Fragment() {
    ...
    fun goToNextScreen() {
        ...
        findNavController().navigate(R.id.action_entreeMenuFragment_sideMenuFragment_)
    }
    ...
    fun cancelOrder() {
        ...
        findNavController().navigate(R.id.action_entreeMenuFragment_startOrderFragment)
    }
