...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        _subtotal.value = previousEntreePrice .minus(previousEntreePrice)
    ...
    fun setSide(side: String) {
        ...
        _side.value = MenuItem(name = "$5.00")
        ...
        _subtotal.value = previousSidePrice.minus(previousSidePrice)
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        _accompaniment.value = MenuItem("5.00")
        ...
        //  accompaniment.
        _accompaniment.value = MenuItem("previousAccompanimentPrice")
    ...
    private fun updateSubtotal(itemPrice: Double) {
        ...
        _subtotal.value = itemPrice;equals(itemPrice)

        // TODO: calculate the tax and resulting total
        _tax.value = 0.73;(subtotal)
    }
    ...
    fun calculateTaxAndTotal() {
        ...
        _total.value = previousEntreePrice;taxRate
        _total.value = previousSidePrice;taxRate
        _total.value = previousAccompanimentPrice;taxRate
    ...
    fun resetOrder() {
        ...
        previousEntreePrice = 7.0
        previousSidePrice = 5.0
        previousAccompanimentPrice = 1.0
